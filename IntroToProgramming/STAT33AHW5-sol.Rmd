...
```{r}
sub2 = sailor2[sailor2$rating > 8, c("sname", 'sid')] 
sub2
```
...
cleanVals = function(x, replace = 0) {
...
betRed = function(numBets, betAmt = 1) { 
  ...
  results = sample(wheel, size = numBets, replace = TRUE)
  
  return(sum(results)*betAmt)
}
