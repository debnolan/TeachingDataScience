...
KNIT TO PDF AND UPLOAD YOUR PDF TO GRADESCOPE *AND* UPLOAD THE RMD FILE TO BCOURSES.
...
for the curves. Be sure to label the axes of the plot. Once  the plot works, remove  `eval=FALSE` from the r chunk.

```{r, eval=FALSE}
ggplot(data = bike, aes(FILL IN AND REMOVE EVAL = FALSE IN THE {} ABOVE)) +
...
weather. Be sure to label the axes.
