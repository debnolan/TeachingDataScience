...
```{r}
ggplot(data = bike_day, aes(x = casual)) +
  geom_histogram(aes(y = ..density..), alpha = 0.4, col = "blue") + 
  labs(x = "Daily Count") +
  geom_histogram(mapping = aes(x = registered, y = ..density..),
                         alpha = 0.4, col = "green")
...
ggplot(bike_day, 
  ...
  geom_density_2d() +
  labs(x = "Daily Counts of Casual Riders", 
       y = "Daily Counts of Registered Riders" )
