...
Function-style expressions can have a side effect, such as making a plot
...
Compound expressions occur when we compse functions by providing the 
return value of one function as the input for another.
